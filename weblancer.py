...
def save(projects, path):
    with open(path, 'w') as csvfile:
        ...
        for project in projects:
            writer.writerow((project['price'], (project['title']),
                             project['cods'], project['brand']))
...
def main():
    ...
    projects = []
    projects.extend(parse(get_html('https://ilovemommy.com.ua/ru/odezhda-dlya'
                                   '-devochek/2-5-years/chelovechki.html')))
